...
for error in parse_data('resistance.txt'): assert error < RESISTANCE_PERCENT_ERROR
print('resistance test PASS')
for error in parse_data('capacitance.txt'): assert error < CAPACITANCE_PERCENT_ERROR
print('capacitance test PASS')
